...
#' organisms and rows the cluster names, the third element the protein
#' sequences loaded as a list of objects of class \code{SeqFastaAA} from the
#' \pkg{seqinr} package, and a series of attributes.
# #' @references
